...
*/
?>
<body class="metalmecanica" onload="load('Metalmecanica');">
        <!--[if lt IE 8]>
    ...
    <div id="header">
      <div class="row">
        ...
        <div class="texSmartphone visible-xs-*">Metalmecanica</div>
        <div class="slider">
          ...
          <ul class="hidden-xs">
            <li>
              <div class="container">
                ...
                <div class="image">
                  <img src="<?php print IMAGES;?>/imagen_slide_metal.png" alt="">
                </div>
              </div>
            </li>
            <li>
          ...
          <img src="<?php print IMAGES;?>/bg_metal.jpg" alt="" class="imgSlider">
        ...
        <div class="detail col-lg-12 col-md-12 col-xs-12">
          <div class="infoItem col-lg-3 col-md-3 col-xs-12 col-sm-4">
            <div class="infoEmpresa">
              <img src="<?php print IMAGES;?>/icon-metalmecanica.png" alt="" class="icon">
