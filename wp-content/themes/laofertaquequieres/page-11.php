...
*/
?>
<body class="cuero" onload="load('Cuero y Calzado');">
        <!--[if lt IE 8]>
    ...
    <div id="header">
      <div class="row">
        ...
        <div class="texSmartphone visible-xs-*">Cuero y Calzado</div>
        <div class="slider">

          <ul class="hidden-xs">
            <li>
              <div class="container">
                <h1>Cuero y Calzado</h1>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut.</p>
                <div class="image">
                  <img src="<?php print IMAGES;?>/imagen_slide_cuero.png" alt="">
                </div>
              </div>
            </li>
            <li>
          ...
          <img src="<?php print IMAGES;?>/bg_cuero.jpg" alt="" class="imgSlider">
    ...
    <div class="row results">
      ...
      <div class="contentItems col-lg-6 col-md-7" >
        ...
        <div id="contCompa">
            ...
            <div class="image">
              <div class="icon"><img src="<?php print IMAGES;?>/icon-cueroycalzado.png" alt=""></div>
        ...
        <div class="detail col-lg-12 col-md-12 col-xs-12">
          <div class="infoItem col-lg-3 col-md-3 col-xs-12 col-sm-4">
            <div class="infoEmpresa">
              <img src="<?php print IMAGES;?>/icon-cueroycalzado.png" alt="" class="icon">
