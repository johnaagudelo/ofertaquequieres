 ...
 */
?>
<body class="salud" onload="load('Salud y Belleza');">
    <!--[if lt IE 8]>
    ...
    <div id="header">
        <div class="row">
            ...
            <div class="slider">
                <?php
                $args = array('post_type' => 'slider', 'posts_per_page' => 10, 'p' => '52');
        ...
        <div class="contentItems col-lg-6 col-md-7" >
            ...
            <div id="contCompa">
                <div class="item col-lg-6 col-sm-6">
                    <div class="image">
                        <div class="icon"><img src="<?php print IMAGES; ?>/icon-saludybelleza.png" alt=""></div>
    ...
    <div class="row results">
      ...
      <div class="map col-lg-6 col-md-5" id="Visor-content">
        ...
        <div class="detail col-lg-12 col-md-12 col-xs-12">
          <div class="infoItem col-lg-3 col-md-3 col-xs-12 col-sm-4">
            <div class="infoEmpresa">
              <img src="<?php print IMAGES;?>/icon-saludybelleza.png" alt="" class="icon">
              <strong>Incio de oferta</strong>
              2015-04-24 - 12:00m
              <strong>Fin de oferta</strong>
              2015-07-24 - 7:00pm
